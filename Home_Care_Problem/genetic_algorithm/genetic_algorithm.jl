function genetic_algorithm(
    ...
    #just_mutation!(population, problem, 10_000, 3, 1, 4, 0.1)
    return population.best_individual
end

function just_mutation!(population, problem, N_ITER, N_SWAP_CURR, N_INVERSION_CURR, N_SHIFT_CURR, PERC_SPLIT_MUTATION_CURR)
    for iter in 1:N_ITER 
        if iter % 100 == 0
            println("Iterazione: ", iter)
            println("Mean fitness: ", population.mean_fitness[end])
